...
<section>
	...
	for($laurels_loop=1 ; $laurels_loop <=5 ; $laurels_loop++): 
	 if(!empty($laurels_options['slider-img-'.$laurels_loop])){
		$laurels_flag=1;
		break;
	}
	endfor;
   ...
   <div class="banner">    	
    ...
    <div class="webpage-container">
     ...
     <div class="section_row_2 col-md-12 no-padding">        	
      ...
      if(!empty($laurels_options['home-icon-'.$laurels_loop])){ ?>
  ...
  <?php } ?>
    ...
    $laurels_image = wp_get_attachment_link(get_post_thumbnail_id(get_the_ID()), 'laurels-home-latestpost-thumbnails' ); ?>
			<div class="owl-item">
