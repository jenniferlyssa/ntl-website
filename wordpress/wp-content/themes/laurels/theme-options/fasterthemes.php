...
function laurels_framework_menu_settings() {
	$laurels_menu = array(
		'page_title' => __( 'FasterThemes Options', 'laurels'),
		'menu_title' => __('Theme Options', 'laurels'),
...
<div class="fasterthemes-themes">
  ...
  <div class="fasterthemes-header">
    <div class="logo">
      <?php $laurels_image=get_template_directory_uri().'/theme-options/images/logo.png';
  ...
  <div class="fasterthemes-details">
        ...
        <!-- F I N A L - - T H E M E - - O P T I O N -->
          ...
          <div id="options-group-1" class="group faster-inner-tabs">   
            ...
            <div class="faster-inner-tab-group active">
                ...
                <input id="logo-img" class="upload" type="text" name="laurels_theme_options[logo]" value="<?php if(!empty($laurels_options['logo'])) { echo esc_url($laurels_options['logo']); } ?>" placeholder="<?php _e('No file chosen','laurels'); ?>" />
            ...
            <div class="section theme-tabs theme-favicon">
              ...
              <div class="faster-inner-tab-group">
                ...
                <div class="ft-control">
                  <input id="favicon-img" class="upload" type="text" name="laurels_theme_options[favicon]" value="<?php if(!empty($laurels_options['favicon'])) { echo esc_url($laurels_options['favicon']); } ?>" placeholder="<?php _e('No file chosen','laurels'); ?>" />
	...
	<h3><?php _e('Banner Slider','laurels'); ?></h3>
            ...
            <div class="section theme-tabs theme-slider-img"> <a class="heading faster-inner-tab" href="javascript:void(0)"><?php _e('Slider','laurels');?> <?php echo $laurels_i;?></a>
              <div class="faster-inner-tab-group">
                <div class="ft-control">
                  <input id="slider-img-<?php echo $laurels_i;?>" class="upload" type="text" name="laurels_theme_options[slider-img-<?php echo $laurels_i;?>]" value="<?php if(!empty($laurels_options['slider-img-'.$laurels_i])) { echo esc_url($laurels_options['slider-img-'.$laurels_i]); } ?>" placeholder="<?php _e('No file chosen','laurels'); ?>" />
	...
	<div id="section-title" class="section theme-tabs"> <a class="heading faster-inner-tab" href="javascript:void(0)"><?php _e('Title','laurels'); ?></a>
            ...
            <div class="section theme-tabs theme-slider-img"> <a class="heading faster-inner-tab" href="javascript:void(0)"><?php _e('Tab','laurels'); echo $laurels_section_i; ?></a>
              <div class="faster-inner-tab-group">
                <div class="ft-control">
                  <input id="first-image-<?php echo $laurels_section_i;?>" class="upload" type="text" name="laurels_theme_options[home-icon-<?php echo $laurels_section_i; ?>]" value="<?php if(!empty($laurels_options['home-icon-'.$laurels_section_i])) { echo esc_url($laurels_options['home-icon-'.$laurels_section_i]); } ?>" placeholder="<?php _e('No file chosen','laurels'); ?>" />
                  <input id="upload_image_button" class="upload-button button" type="button" value="<?php _e('Upload','laurels'); ?>" />
