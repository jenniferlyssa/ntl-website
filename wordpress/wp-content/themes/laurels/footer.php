	...
	<div class="container webpage-container">
   		<div class="col-sm-6 col-md-9  no-padding bottom-footer">
			...
			<span class='foot_txt text-left'>
                <?php _e('Powered by ','laurels'); ?><a href='http://fasterthemes.com/wordpress-themes/laurels' target='_blank'><?php _e('Laurels WordPress Theme','laurels'); ?></a>
			</span>
        </div>
        <div class="col-sm-6 col-md-3 no-padding bottom-footer">
        	<ul>
                ...
                <?php }
                    if(!empty($laurels_options['linkedin'])) { ?>
