    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
				...
				<?php if( isset($edsbootstrap_options["blog"]["heading"]) ): ?>
                    <h1 class="title"><?php echo $edsbootstrap_options["blog"]["heading"]; ?></h1>
					<?php if ( isset( $edsbootstrap_options["blog"]["sub_heading"] ) ) { ?>
                    	<div class="subtitle"><?php echo $edsbootstrap_options["blog"]["sub_heading"]; ?></div>
                    <?php }?>
                <?php else : ?>
